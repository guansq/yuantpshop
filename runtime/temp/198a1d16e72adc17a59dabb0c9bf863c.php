<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"./template/pc/rainbow/goods/goodsInfo.html";i:1524561559;s:40:"./template/pc/rainbow/public/header.html";i:1524561559;s:47:"./template/pc/rainbow/public/header_search.html";i:1524561559;s:46:"./template/pc/rainbow/public/footer_index.html";i:1524561559;s:46:"./template/pc/rainbow/public/sidebar_cart.html";i:1524561559;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
						...
						<div class="shop-price-cou">
							...
							<div class="shop-cou-ri">
                                ...
                                <?php if($goods['prom_type'] != 2): ?>
									<div class="br1"></div>
									<div class="allcomm">
										<p>累计销量</p><p class="f_blue"><?php echo $goods['sales_sum']; ?></p>
									</div>
								<?php endif; ?>
							</div>
						</div>
							...
							<ul class="list1">
								...
								<li class="summary-stock though-line">
									<div class="dd shd_address">
										...
										<span id="dispatching_msg" <?php if($dispatching[status] != 1): ?>style="display: none;"<?php endif; ?>>可配送</span>
				...
				<?php if($store['store_id'] == 1): ?>
					<div class="detail-ry p">
						...
						<div class="reception p">
							<a href="tencent://message/?uin=<?php echo $store['store_qq']; ?>&Site=TPshop商城&Menu=yes">
