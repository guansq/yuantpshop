<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./template/pc/rainbow/user/login.html";i:1524561560;s:40:"./template/pc/rainbow/public/footer.html";i:1524561559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="header area">
    <a href="/index.php" class="logo_s" title="首页" style="margin: 10px 0;height: 59px; ">
        <img src="<?php echo $tpshop_config['shop_info_store_logo']; ?>" style="max-width: 240px;height: 80px; margin-bottom: 10px;"/>
    </a>
...
<div class="m-login" style="background-color: #bf1919;" id="divMLogin">
  <div class="login-wrap">
    <div class="banner">
        <?php $pid =9;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1524618000 and end_time > 1524618000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
