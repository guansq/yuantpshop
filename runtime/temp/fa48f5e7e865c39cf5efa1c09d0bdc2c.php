			...
			<?php
				...
				<li>
					<div class="pad">
						...
						<div class="shop_name2">
							<a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$favourite[goods_id])); ?>"><?php echo $v['goods_name']; ?></a>
						</div>
						<div class="price-tag">
