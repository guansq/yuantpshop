<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/pc/rainbow/goods/ajaxComment.html";i:1524561559;}*/ ?>
    ...
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 bolist p">
                ...
                <span>购买<?php echo round(($v['add_time']-$v['pay_time'])/3600/24); ?>天后<?php echo $v['user_id']; ?>,,<?php echo $user['user_id']; ?>评价</span>
        ...
        <div class="g_come">
            ...
            <a href="javascript:void(0);" onclick="zan(this);"  data-comment-id="<?php echo $v['comment_id']; ?>">
                <i class="detai-ico z-ten"></i>
                <span id="span_zan_<?php echo $v['comment_id']; ?>" data-io="<?php echo (isset($v['zan_num']) && ($v['zan_num'] !== '')?$v['zan_num']:0); ?>"><?php echo (isset($v['zan_num']) && ($v['zan_num'] !== '')?$v['zan_num']:0); ?></span>
            </a>
        </div>
    </div>
